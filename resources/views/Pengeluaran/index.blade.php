                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Table Data Pengeluaran</h3>
                        </div>
                        <!-- /.card-header -->
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                @forelse ($Pengeluaran as $key => $value)
                                <tr>
                                    <td>{{ $value->nama }}</td>
                                    <td>{{ $value->jumlah }}</td>
                                    <td>{{ $value->catatan }}</td>
                                    ...
                                    <td>
                                        ...
                                        @csrf
                                        @method('DELETE')
                                            <a href="{{ route('Pengeluaran.show', $value->id) }}" class="btn-sm btn-info">Show</a>
                                            <a href="{{ route('Pengeluaran.edit', $value->id) }}" class="btn-sm btn-warning">Edit</a>
